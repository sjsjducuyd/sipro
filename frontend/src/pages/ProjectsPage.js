    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-1.5"><Label>Prefix</Label>
            <Input value={form.prefix} onChange={(e) => set("prefix", e.target.value.toUpperCase())} /></div>
          ...
          <div className="space-y-1.5"><Label>Harga (Rp)</Label>
            <Input type="number" value={form.price} onChange={(e) => set("price", e.target.value)} /></div>
          <div className="space-y-1.5"><Label>Jumlah</Label>
            <Input type="number" value={form.count} onChange={(e) => set("count", e.target.value)} /></div>
          <div className="space-y-1.5"><Label>Mulai Index</Label>
            <Input type="number" value={form.start_index} onChange={(e) => set("start_index", e.target.value)} /></div>
        </div>
        <DialogFooter>
          <Button variant="outline" onClick={() => onOpenChange(false)} disabled={busy}>Batal</Button>
