    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-lg">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-1.5"><Label>Kode Biaya</Label><Input value={form.cost_code} onChange={(e) => set("cost_code", e.target.value)} placeholder="mis. STR-01" /></div>
          ...
          <div className="space-y-1.5 sm:col-span-2"><Label>Uraian Pekerjaan</Label><Input value={form.description} onChange={(e) => set("description", e.target.value)} placeholder="mis. Beton K-300 kolom & balok" /></div>
          ...
          <div className="space-y-1.5"><Label>Volume</Label><Input type="number" value={form.quantity} onChange={(e) => set("quantity", e.target.value)} /></div>
          <div className="space-y-1.5 sm:col-span-2"><Label>Harga Satuan (Rp)</Label><Input type="number" value={form.unit_price} onChange={(e) => set("unit_price", e.target.value)} /></div>
        </div>
