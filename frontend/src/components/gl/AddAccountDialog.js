    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="grid gap-4">
          <div className="space-y-1.5"><Label>Kode Akun</Label><Input value={form.code} onChange={(e) => set("code", e.target.value)} placeholder="mis. 6-1400" /></div>
          <div className="space-y-1.5"><Label>Nama Akun</Label><Input value={form.name} onChange={(e) => set("name", e.target.value)} placeholder="mis. Beban Sewa" /></div>
