    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-lg">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-1.5"><Label>Tanggal</Label><Input type="date" value={form.log_date} onChange={(e) => set("log_date", e.target.value)} /></div>
          ...
          <div className="space-y-1.5"><Label>Jumlah Pekerja</Label><Input type="number" min={0} value={form.workforce} onChange={(e) => set("workforce", e.target.value)} /></div>
          <div className="space-y-1.5"><Label>Peralatan</Label><Input value={form.equipment} onChange={(e) => set("equipment", e.target.value)} placeholder="mis. mixer, vibrator" /></div>
          <div className="space-y-1.5 sm:col-span-2"><Label>Uraian Pekerjaan</Label><Textarea rows={2} value={form.work_description} onChange={(e) => set("work_description", e.target.value)} /></div>
          <div className="space-y-1.5 sm:col-span-2"><Label>Material Diterima/Dipakai</Label><Input value={form.materials} onChange={(e) => set("materials", e.target.value)} /></div>
          <div className="space-y-1.5 sm:col-span-2"><Label>Kendala</Label><Textarea rows={2} value={form.obstacles} onChange={(e) => set("obstacles", e.target.value)} /></div>
