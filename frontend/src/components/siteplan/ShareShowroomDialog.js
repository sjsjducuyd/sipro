        ...
        {loading ? <LoadingCards count={1} /> : error ? (
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input data-testid={SITE_PLAN.shareHeadline} value={cfg?.headline || ""}
                placeholder="mis. Hunian asri 10 menit ke pusat kota"
                onChange={(e) => setCfg((c) => ({ ...c, headline: e.target.value }))} />
            </div>
            <div className="space-y-1.5">
              <Label>Nomor WhatsApp marketing</Label>
              <Input data-testid={SITE_PLAN.shareWa} value={cfg?.contact_wa || ""}
