        ...
        <DialogContent className="max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input data-testid={OMNI.tmplName} value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Textarea data-testid={OMNI.tmplBody} rows={4} value={form.body}
                onChange={(e) => setForm({ ...form, body: e.target.value })} placeholder="Halo {{name}}, ..." />
            </div>
            <div className="space-y-1.5">
              <Label>Variabel (pisahkan koma)</Label>
              <Input value={form.variables} onChange={(e) => setForm({ ...form, variables: e.target.value })} placeholder="name, date" />
            </div>
          </div>
          <DialogFooter>
