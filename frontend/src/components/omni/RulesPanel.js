        ...
        <DialogContent className="max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input data-testid={OMNI.ruleName} value={form.name}
            ...
            {form.trigger_event === "message.received" && (
              <div className="space-y-1.5">
                ...
                <Input data-testid={OMNI.ruleKeywords} value={form.keywords}
                  onChange={(e) => setForm({ ...form, keywords: e.target.value })} placeholder="harga, kpr, survey" />
              </div>
            )}
            {form.trigger_event === "no_response" && (
              <div className="space-y-1.5">
                <Label>Diam berapa hari</Label>
                <Input data-testid={OMNI.ruleDays} type="number" min={1} value={form.no_response_days}
