        ...
        {done ? (
          ...
          <div className="space-y-3">
            <div className="space-y-1.5">
              ...
              <Input data-testid={SHOWROOM.leadName} value={form.name} autoComplete="name"
                placeholder="mis. Rina Puspita" onChange={(e) => set("name", e.target.value)} />
            </div>
            <div className="space-y-1.5">
              <Label>Nomor WhatsApp</Label>
              <Input data-testid={SHOWROOM.leadPhone} value={form.phone} inputMode="tel"
                autoComplete="tel" placeholder="mis. 081234567890"
                onChange={(e) => set("phone", e.target.value)} />
            </div>
            <div className="space-y-1.5">
              <Label>Pesan (opsional)</Label>
              <Textarea data-testid={SHOWROOM.leadMessage} rows={3} value={form.message}
