      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-1.5 sm:col-span-2">
            ...
            <Input data-testid="phase-edit-name" value={name} onChange={(e) => setName(e.target.value)} />
          </div>
          <div className="space-y-1.5">
            <Label>Bobot (%)</Label>
            <Input data-testid="phase-edit-weight" type="number" value={weight}
              onChange={(e) => setWeight(e.target.value)} />
          </div>
          <div className="space-y-1.5">
            <Label>Rencana (%)</Label>
            <Input data-testid="phase-edit-planned" type="number" value={planned}
