      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-md">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-1.5 sm:col-span-2">
            ...
            <Input data-testid={PROJECT_EDIT.unitFormPrice} type="number" value={form.price}
          ...
          <div className="space-y-1.5">
            ...
            <Input data-testid={PROJECT_EDIT.unitFormLuasTanah} type="number" min={0}
              value={form.luas_tanah} placeholder="mis. 120"
              onChange={(e) => set("luas_tanah", e.target.value)} />
          </div>
          <div className="space-y-1.5">
            <Label>Luas bangunan (m²)</Label>
            <Input data-testid={PROJECT_EDIT.unitFormLuasBangunan} type="number" min={0}
