      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-1.5 sm:col-span-2">
            ...
            <Input data-testid={PROJECT_EDIT.formName} value={form.name}
              onChange={(e) => set("name", e.target.value)} />
          </div>
          <div className="space-y-1.5">
            <Label>Kode</Label>
            <Input data-testid={PROJECT_EDIT.formCode} value={form.code}
          ...
          <div className="space-y-1.5 sm:col-span-2">
            <Label>Lokasi</Label>
            <Input data-testid={PROJECT_EDIT.formLocation} value={form.location}
