        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-1.5"><Label>Proyek</Label>
            <Select value={form.project_id} onValueChange={(v) => set("project_id", v)}>
              <SelectTrigger data-testid={PERMITS.formProject}><SelectValue placeholder="Pilih proyek" /></SelectTrigger>
          ...
          <div className="space-y-1.5 sm:col-span-2"><Label>Nama Dokumen</Label>
            <Input value={form.name} onChange={(e) => set("name", e.target.value)} placeholder="mis. Persetujuan Bangunan Gedung" /></div>
          <div className="space-y-1.5"><Label>No. Referensi</Label>
            <Input value={form.reference_no} onChange={(e) => set("reference_no", e.target.value)} /></div>
          ...
          <div className="space-y-1.5 sm:col-span-2"><Label>Tenggat</Label>
            <Input type="date" value={form.deadline} onChange={(e) => set("deadline", e.target.value)} /></div>
          <div className="space-y-1.5 sm:col-span-2"><Label>Catatan</Label>
