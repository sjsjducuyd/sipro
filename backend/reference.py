...
# Fase 27: grup enum modul baru (Kas Bon, Aset Tetap, Pembiayaan Korporat, Marketing Fee)
# hidup di `reference_p27.py` agar file ini tetap di bawah batas compliance, tetapi
# REGISTRY-nya tetap SATU — digabung di sini sehingga validator backend, endpoint
# /api/reference, dan tab Kamus Data otomatis mengenalinya.
from reference_p27 import GROUPS_P27 as _GROUPS_P27  # noqa: E402
from reference_p28 import GROUPS_P28 as _GROUPS_P28, SYNONYMS_P28 as _SYN_P28  # noqa: E402
from reference_p29 import GROUPS_P29 as _GROUPS_P29  # noqa: E402

from reference_p31 import GROUPS_P31 as _GROUPS_P31  # noqa: E402
from reference_p33 import GROUPS_P33 as _GROUPS_P33  # noqa: E402
from reference_p34 import GROUPS_P34 as _GROUPS_P34  # noqa: E402
for _extra in (_GROUPS_P27, _GROUPS_P28, _GROUPS_P29, _GROUPS_P31, _GROUPS_P33, _GROUPS_P34):
    GROUPS.update(_extra)
SYNONYMS: dict = {
    **_SYN_P28,
    "uom": {
